...
export const USER_STORY_MAP = {
  ...
  insurance_claim_information_inquiry: INSURANCE_CLAIM_INFORMATION_INQUIRY_PROMPT,
  overseas_study_accident_insurance_details: OVERSEAS_STUDY_ACCIDENT_INSURANCE_DETAILS_PROMPT,
  food_safety_liability_insurance_details: FOOD_SAFETY_LIABILITY_INSURANCE_DETAILS_PROMPT,
  hospital_insurance_premium_calculation: HOSPITAL_INSURANCE_PREMIUM_CALCULATION_PROMPT,
  plateau_travel_insurance_premium_calculation: PLATEAU_TRAVEL_INSURANCE_PREMIUM_CALCULATION_PROMPT,
  employers_liability_insurance_premium_calculation: EMPLOYERS_LIABILITY_INSURANCE_PREMIUM_CALCULATION_PROMPT,
  adult_accident_insurance_premium_calculation: ADULT_ACCIDENT_INSURANCE_PREMIUM_CALCULATION_PROMPT,
  pet_care_insurance_premium_calculation: PET_CARE_INSURANCE_PREMIUM_CALCULATION_PROMPT
};
