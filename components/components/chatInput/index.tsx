...
export default function ChatInput({ openWhiteboard, showAnim }: props) {
  ...
  const { getInputProps, open } = useContext(UploadFileContext);

  const [loading, setLoading] = useState<boolean>(false);

  const { initCreateText, setInitCreateText, setInitCreate, initCreate } =
