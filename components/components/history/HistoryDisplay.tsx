...
export default function HistoryDisplay({
  ...
  return history && history.length === 0 ? null : (
    <div className="flex flex-col h-screen">
      <h1 className="font-bold mb-2 mt-2">History</h1>
              ...
              <HoverCard>
                <HoverCardTrigger
                  className={classNames(
                    "rounded-lg space-x-2 cursor-pointer w-full block border relative overflow-hidden",
                    {
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: `url(${
                        item.screenshot ||
                        "https://www.ancodeai.com/placeholder.svg"
                      })`,
                    }}
                  ></div>
